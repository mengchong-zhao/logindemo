package com.vdian.logindemo.persist.impl;

import com.vdian.logindemo.persist.Account;
import com.vdian.logindemo.persist.AccountPersistException;
...
public class AccountPersistServiceImpl implements AccountPersistService {
    ...
    public Account readAccount(String id) throws AccountPersistException{
        Document doc = readDocument();
        Element accountsFile = doc.getRootElement().element(ELEMENT_ACCOUNTS);
        for(Element element : (List<Element>)accountsFile.elements()){
    ...
    private Element buildAccountElement(Account account){
        ...
        element.addElement(ELEMENT_ACCOUNT_ACTIVATED).setText(
                        account.getActivated() ? "true" : "false");
    ...
    private Document readDocument() throws AccountPersistException {
        ...
        try {
            ...
            throw new AccountPersistException("unable to read persist data xml");
        }
    }
